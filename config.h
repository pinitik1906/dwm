...
static const Key keys[] = {
	...
	{ 0,				XK_Print,  		 spawn,          	SHCMD("scrot $HOME/stuffs/pic/screenshots/screenshot-%m-%d-%Y_%T.png -izs -l mode=edge && $(notify-send -t 1250 screenshot_taken)") },
	{ ControlMask,			XK_Print,  		 spawn,          	SHCMD("scrot $HOME/stuffs/pic/screenshots/screenshot-%m-%d-%Y_%T.png && $(notify-send -t 1250 screenshot_taken)") },
