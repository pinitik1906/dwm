...
static const Key keys[] = {
	...
	{ MODKEY,			XK_comma,      		 spawn,  	   	SHCMD("i3lock --nofork --radius 50 --inside-color=00000000 --line-uses-inside --verif-size=16 --verif-text=Verifying --wrong-size=16 --wrong-text=Wrong -Fec 00000000 | loginctl suspend") },
	...
	{ ControlMask,			XK_Print,  		 spawn,          	SHCMD("scrot -z $HOME/stuffs/pic/screenshots/screenshot-%m-%d-%Y_%T.png && $(notify-send -t 1250 screenshot_taken)") },
